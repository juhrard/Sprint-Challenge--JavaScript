...
// universities.forEach(array => array.toUpperCase());
...
//let unisWithUni = universities.filter(element => element.university === 'Uni');

//let unisWithUni = []

// function filterUnis(array) {
...
const unisWithUni = universities.filter(element => element.includes('Uni'));

//universities.find(element => element === 'Uni');
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currentVal) => accumulator + currentVal.population, 0);
